...
oltp_conn_string = "postgresql://postgres:123@localhost:5432/OLTP1"
warehouse_conn_string = "postgresql://postgres:123@localhost:5432/DWH1"
...
warehouse_tables = {
    ...
    "orders": "fact_orders",
    "pcategory": "dim_product_category",
...
ddl_statements = {
    ...
    "dim_products": """
        CREATE TABLE IF NOT EXISTS dim_products (
            ...
            CONSTRAINT fk_product_category_id FOREIGN KEY (product_category_id) REFERENCES dim_product_category (product_category_id)
        );
   """,
    "fact_order_items": """      
        CREATE TABLE IF NOT EXISTS fact_order_items (
            ...
            CONSTRAINT fk_order_id FOREIGN KEY (order_id) REFERENCES fact_orders (order_id)
        );
    """
}
